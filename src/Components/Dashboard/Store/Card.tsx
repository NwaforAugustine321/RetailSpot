			...
			{user && (
				<DropDownContainer>
					<DropDown>
						...
						<DropDownItem>View Store Bookings</DropDownItem>
						<DropDownItem>Edit Store</DropDownItem>
						<DropDownItem>Deactivate Store</DropDownItem>
						<DropDownItem>Delete Store</DropDownItem>
					</DropDown>
				</DropDownContainer>
			)}
		</Container>
